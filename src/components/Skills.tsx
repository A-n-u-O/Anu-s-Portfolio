      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        {techStack.map((group, groupIdx) => (
          <div key={groupIdx} className="space-y-8">
            <h3 className="text-lg font-semibold bg-gradient-to-r from-blue-400 via-pink-400 to-pink-300 bg-clip-text text-transparent tracking-wide">
              {group.category}
            </h3>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
              {group.items.map((tech, idx) => (
                <motion.div
                  ...
                  className="bg-[#111111] border border-gray-800 border-b-amber-100 rounded-2xl flex flex-col items-center justify-center gap-2 py-8 shadow-md hover:shadow-blue-500/20 transition"
                >
